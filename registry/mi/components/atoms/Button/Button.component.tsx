import { cn } from "@/registry/mi/libs/utils.lib";
import { Box, BoxRF } from "@/registry/mi/types/component.type";
  ...
  "inline-flex justify-center items-center gap-2 border border-solid rounded-full focus-visible:outline-none focus-visible:ring-2 font-satoshi whitespace-nowrap transition-colors disabled:pointer-events-none",
  {
    ...
    variants: {
      ...
      variant: {
        ...
        "outline-danger":
          "bg-transparent  border-error-danger-500 hover:bg-error-danger-50 text-error-danger-500 ring-neutral-100  disabled:text-error-danger-300 disabled:border-error-danger-200",
        "outline-gray":
        ...
        white:
          "bg-base-white border-base-white text-gray-800 hover:bg-gray-300 hover:border-gray-bg-gray-300 ring-gray-100 disabled:opacity-50",
      },
    },
  },
);
  ...
  (props, ref) => {
    ...
    return (
      <Element
        ...
        ref={ref}
        name="Button"
        aria-label={restProps.name ?? "Button"}
        title={restProps.name ?? "Button"}
        {...restProps}>
        {startIcon}
        {children}
        {endIcon}
